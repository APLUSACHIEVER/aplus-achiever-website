...
*/
(function(){'use strict';
const GNAME='APLUS_P6_PSLE_PAPER2_GENERATION_V1',BANKNAME='APLUS_AI_DB_V1_P6_PSLE_VISUAL_TEXT_DNA_BATCH04',VERSION='PSLE_VISUAL_TEXT_DNA_V6.0';
...
function install(){
 ...
 G.generate=function(options={}){
   ...
   const eligible=bank.filter(t=>QDB&&QDB.records&&QDB.records[t.id]); const pool=eligible.length?eligible:bank; const t=pool[Math.floor(r()*pool.length)];
