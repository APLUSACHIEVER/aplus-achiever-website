...
function registry(){return{
 grammar:uniq([].concat(REAL2026().filter(x=>x.section==='grammar'),get('APLUS_AI_DB_V1_P6_PSLE_PAPER2_CORE_GRAMMAR_BATCH01'),get('APLUS_AI_DB_V1_P6_GRAMMAR_QUESTION_BANK'),get('APLUS_AI_DB_V1_GRAMMAR_P6_QUESTION_BANK'),get('APLUS_AI_DB_V1_GRAMMAR_P6_EXPANSION_BATCH02'),get('APLUS_AI_DB_V1_GRAMMAR_P6_EXPANSION_BATCH03'),get('APLUS_AI_DB_V1_GRAMMAR_P6_EXPANSION_BATCH04'))),
 vocab:uniq([].concat(REAL2026().filter(x=>x.section==='vocabulary'),get('APLUS_AI_DB_V1_P6_PSLE_PAPER2_MASTER_VOCABULARY_CONTENT_B03'),get('APLUS_AI_DB_V1_P6_PSLE_PAPER2_CORE_VOCABULARY_BATCH02'))),
...
realGrammar:uniq(REAL2026().filter(x=>x.section==='grammar')),realVocab:uniq(REAL2026().filter(x=>x.section==='vocabulary')),realVocabCloze:uniq(REAL2026().filter(x=>x.section==='vocabularyCloze'))
}};
...
window.APLUS_P6_PSLE_PAPER2_GENERATION_V1={version:'1.7',blueprint:BP,registry,generate};
})();